...
// This is for summary display purpose
// because we wan't to enable direct links to
// offending lines.
//
// Example:
//
...
// // 1If the process write stream is TTY, then we can print with colors
// @@ -43,2 +44,2 @@
// error: red
// warning: yellow
// @@ -118,0 +120,49 @@
...
//
// Result: array of object with lineNumber as key, associated contents as values.
//
// [
  ...
  return content
    ...
    .reduce((acc, text) => {
      ...
      if (newLineNumber) {
        ...
        acc.push([currentGroupNumber, text])
